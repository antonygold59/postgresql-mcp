...
export function createExtensionsResource(adapter: PostgresAdapter): ResourceDefinition {
    return {
        ...
        handler: async (_uri: string, _context: RequestContext) => {
            ...
            const installedNames = installed.map((e: Record<string, unknown>) => e['extname'] as string);
            ...
            const optionalExtensions = ['vector', 'postgis', 'pg_trgm', 'fuzzystrmatch'];
